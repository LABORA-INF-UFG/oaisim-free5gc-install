...
Elements of OpenAirInterface can be executed without Free5GC elements, but the internet connection test presented in Section ["_Testing User Equipments (UE) Internet Connection_"](https://github.com/LABORA-INF-UFG/oaisim-free5gc-install#4---testing-user-equipments-ue-internet-connection)
