...
This is a control parameter of free5gc process simulation start. The default value is **false**, if you decide set this parameter with **true** in deployment process, the steps described into section 3.1 not be necessary.